...
public static class ModelBuilderExtensions
{
    ...
    {
        Expression<Func<IBaseEntity, bool>> filterExpr = bm => !bm.IsArchived;
        foreach (var mutableEntityType in modelBuilder.Model.GetEntityTypes())
        {
            if (mutableEntityType.ClrType.IsAssignableTo(typeof(IBaseEntity)) && mutableEntityType.BaseType == null)
            {
